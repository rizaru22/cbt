...
open_form("modal_soal", "return save_data()");
   ...
   create_mediapicker("Audio", "audio", 4, 2, "modal_soal");
...
echo '<a href="../media/template_soal.xls" class="btn btn-success pull-right"><span class="glyphicon glyphicon-floppy-save"></span> Download Format .xls</a>';
