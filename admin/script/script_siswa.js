...
function save_data(){
   if(save_method == "add") url = "ajax/ajax_siswa.php?action=insert";
...
function print_data(){
   var idkelas=$('#kelas_print').val();
  //alert('Tidak dapat menyimpan data!'+idkelas);
  $("#printabel").remove();
  $("<iframe id='printabel'>")    
        .hide()                     
        .attr("src", "export/cetak_kartu.php?kelas="+idkelas) 
        .appendTo("body");    
}
